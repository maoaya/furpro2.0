                    ...
                    if (i === metodos.length - 1) {
                        setTimeout(() => {
                            try {
                                ...
                                console.error(`❌ Todos los métodos fallaron. Último error:`, finalErr
    or);

                                // Mostrar mensaje al usuario
                                const mensaje = `No se pudo navegar automáticamente a ${url}. Por favo
    r, ve manualmente a esa dirección.`;
                                alert(mensaje);
                            }
                        }, 1000);
                    }
