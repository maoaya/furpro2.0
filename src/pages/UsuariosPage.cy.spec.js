describe('UsuariosPage Facebook Style', () => {
  it('muestra paneles izquierdo y derecho, feed central y controles lógicos', () => {
    ...
    cy.mount(<UsuariosPageMock />);
    cy.contains('Panel de Usuarios').should('exist');
    cy.contains('Usuario: Ana Torres').should('exist');
    cy.contains('Rol: Admin').should('exist');
