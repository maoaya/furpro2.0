...
export default function EditarEstadisticasPage() {
  const [actividad, setActividad] = useState([5, 2, 3, 1, 4]);
  const [msg, setMsg] = useState('');

  function handleGuardar() {
    setMsg('Guardando estadísticas...');
    setTimeout(() => setMsg(''), 2000);
  }
  function handleValidar() {
    setMsg('Validando estadísticas...');
    setTimeout(() => setMsg(''), 2000);
  }
