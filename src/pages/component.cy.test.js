...
const ComponentCyTestPage = () => {
  ...
  // Vista de test: no se utiliza la lista filtrada directamente
...
export default ComponentCyTestPage;

// Test placeholder para Jest
test('component.cy page placeholder', () => {
