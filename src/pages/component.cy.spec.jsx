...
describe('Component Facebook Style', () => {
  it('muestra paneles izquierdo y derecho, feed central y controles lógicos', () => {
          ...
          <main style={{ flex: 1, padding: 32, background: '#222' }}>
            <div style={{ background: '#FFD700', color: '#222', borderRadius: 16, padding: 32, boxShadow: '0 2px 12px #0006', maxWidth: 600, margin: '0 auto' }}>
              ...
              <svg width="100%" height="40" style={{ background: '#222' }}>
                <rect x={0} y={20} width={20} height={20} fill="#FFD700" rx={3} />
                <rect x={22} y={10} width={20} height={30} fill="#FFD700" rx={3} />
                <rect x={44} y={5} width={20} height={35} fill="#FFD700" rx={3} />
              </svg>
    ...
    cy.contains('Panel Izquierdo').should('exist');
    cy.contains('Feed Central').should('exist');
    cy.contains('Panel Derecho').should('exist');
