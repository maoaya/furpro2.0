...
import CrearPostPage from './pages/CrearPostPage.jsx';
...
export default function FutProAppDefinitivo() {
  ...
  <Route path="/registro-nuevo" element={<RegistroCompleto />} />
      ...
      {/* Selección de categoría para nuevos usuarios */}
      ...
      {/* Card de Perfil tipo Instagram - Sin protección para flujo OAuth */}
      <Route path="/perfil-card" element={<PerfilCard />} />
      
      {/* Crear Post - Tipo Instagram */}
      ...
      {/* Feed/Actividad - Estados Sociales */}
      ...
      {/* Estados - Página dedicada de estados sociales */}
      ...
      {/* Amigos - Gestión de amigos y conexiones */}
